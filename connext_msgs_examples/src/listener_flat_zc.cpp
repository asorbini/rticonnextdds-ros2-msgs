...
#include "ros2/flat_zc/std_msgs/msg/String.hpp"

using namespace dds::core;
using namespace ros2::flat_zc::std_msgs::msg;

namespace rti { namespace connext_msgs_examples
{
// Create a Listener class that subclasses the generic rclcpp::Node base class.
// The main function below will instantiate the class as a ROS node.
class DdsListenerFlatZc : public rclcpp::Node,
  public dds::sub::NoOpDataReaderListener<String>
{
public:
  CONNEXT_MSGS_EXAMPLES_PUBLIC
  explicit DdsListenerFlatZc(const rclcpp::NodeOptions & options)
  : Node("dds_listener_flat_zc", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_msgs_examples::DdsListenerFlatZc)
