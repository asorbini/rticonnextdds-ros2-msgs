...
#include "ros2/basic/std_msgs/msg/String.hpp"

using namespace std::chrono_literals;
using namespace dds::core;
using namespace ros2::basic::std_msgs::msg;
...
public:
  ...
  : Node("talker", options)
  {
    ...
    auto publish_message =
      [this]() -> void
      {
        String msg("Hello World: " + std::to_string(count_++));
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_msgs_examples::DdsTalker)
