...
class DdsTalkerFlatZc : public rclcpp::Node
{
public:
  CONNEXT_MSGS_EXAMPLES_PUBLIC
  explicit DdsTalkerFlatZc(const rclcpp::NodeOptions & options)
  : Node("talker_flat_zc", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_msgs_examples::DdsTalkerFlatZc)
