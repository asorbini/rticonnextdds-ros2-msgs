...
class DdsTalkerZc : public rclcpp::Node
{
public:
  CONNEXT_MSGS_EXAMPLES_PUBLIC
  explicit DdsTalkerZc(const rclcpp::NodeOptions & options)
  : Node("talker_zc", options)
  {
    ...
    auto publish_message =
      [this]() -> void
      {
        ...
        snprintf(msg->data().data(),  255,
          "Hello World: %lu", count_++);
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_msgs_examples::DdsTalkerZc)
