...
#include "ros2/zc/std_msgs/msg/String.hpp"

using namespace dds::core;
using namespace ros2::zc::std_msgs::msg;

namespace rti { namespace connext_msgs_examples
{
// Create a Listener class that subclasses the generic rclcpp::Node base class.
// The main function below will instantiate the class as a ROS node.
class DdsListenerZc : public rclcpp::Node,
  public dds::sub::NoOpDataReaderListener<String>
{
public:
  CONNEXT_MSGS_EXAMPLES_PUBLIC
  explicit DdsListenerZc(const rclcpp::NodeOptions & options)
  : Node("dds_listener_zc", options)
  {
    ...
    for (auto it = samples.begin(); it != samples.end(); it++)
    {
      if (it->info().valid()) {
        ...
        RCLCPP_INFO(this->get_logger(),
          "I heard from Connext: [%s]", msg.data().data());
      }
    }
  }
...
RCLCPP_COMPONENTS_REGISTER_NODE(rti::connext_msgs_examples::DdsListenerZc)
